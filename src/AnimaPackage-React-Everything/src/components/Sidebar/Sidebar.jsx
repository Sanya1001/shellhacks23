...
export const Sidebar = ({
  ...
  segmentSegmentCellIcon = <Collection1 className="icon-instance-node" color="#767676" />,
  segmentSegmentCellIcon1 = <ChatAlt21 className="icon-instance-node" color="white" />,
}) => {
  return (
    <div className={`sidebar ${className}`}>
      ...
      <Segment
        ...
        hasFrame={false}
        override={segmentSegmentCellIcon1}
        property1="default"
        segmentCellIcon={segmentSegmentCellIcon}
