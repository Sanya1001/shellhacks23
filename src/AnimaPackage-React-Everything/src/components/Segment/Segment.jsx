...
import { Puzzle5 } from "../../icons/Puzzle5";
...
export const Segment = ({
  ...
  className,
  frameClassName,
  segmentCellIcon = <Puzzle5 className="puzzle-5" color="#767676" />,
  segmentCellText = "Сreative",
  frameClassNameOverride,
  segmentCellText1 = "Сreative",
  override = <Puzzle5 className="puzzle-5" color="white" />,
  hasFrame = true,
}) => {
  return (
      ...
      {hasFrame && (
        <div className="frame-3">
          <SegmentCell
            ...
            icon={<Puzzle5 className="puzzle-5" color="#767676" />}
            state="default"
            text="Сreative"
          />
        </div>
